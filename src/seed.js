...
// Member is the name of the model it's assigned the model and schema from mongoose.
...
let contacts = [{
    ...
    "author": "Redactor",
    "PublishedAt": "Published on the {{$ctrl.member.PublishedAt*1000 | date:' dd-MMMM-yyyy  @  hh:mm'}}  ",
